...
heap interpolant synthesis. Our approach reduces the verification problem to
...
various ways, with varying degrees of expressiveness and automation. We demonstrate one example of such an external oracle, a human who can interact with the prover by looking at positive and negative examples of concrete heaps, and propose generalized heap patterns.
\end{abstract}

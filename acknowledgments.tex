...
\begin{abstract}
  ...
  thesis is a prolonged struggle with depression. It was in late 2014 that I
  recognized I was depressed, though it was likely going on for much longer.
  Several personal difficulties made graduate school a place of despair, and
  I decided to leave because I hated being in an environment where I wasn't
  being nurtured at all. After much struggle with finishing up the research for
  the thesis, I finally left at the end of 2015, only to struggle for several more
  months with finishing the thesis. When in August 2016 I was finally close to
  finishing, but still missed the submission deadline, the department gave
  me no options, but to register for another semester and pay thousands of
  dollars of tuition. All this while, I felt completely dejected and did
  not think this research was worth the pain it was causing. But I held on,
  and fought the system. It took a certain amount of escalation and help
  from the disabled students program to get the department to even consider
  a special extension.

  I don't intend to share this story to get some sympathy. My intention is
  to point out that the system failed me in many ways. Even though I mentioned several
  times that I was depressed, nobody ever mentioned that I should go to the
  Disabled Students Program (DSP) to seek help, since my condition was actively
  stopping me from making progress on the thesis. The department refused an
  extension on principle, even though mental health issues, disabled care act etc.
  Wasn't until therapist pointed out.
\end{abstract}
...
Formal verification techniques are currently computationally expensive/undecidable, or require highly specialized engineers with deep knowledge of software technology and mathematical theorem-proving techniques. These constraints make current techniques expensive and time-consuming, and crowdsourcing is being explored as an alternative. Crowdmine \cite{wenchao2012} is ... . The Crowd Sourced Formal Verification (CSFV) program by DARPA\footnote{Defense Advanced Research Projects Agency} resulted in \cite{verigames}.

\cite{fast2013, lebras2013, ernst2012, pastore2013}

Crowdsourcing has been successfully used in other areas as well. Eyewire \cite{eyewire} is a popular example. Also proceedings of HCOMP over the last four years.
% Us

...
\begin{figure}
  ...
  \caption{The initial pattern candidate provided by the user. At this point, the user does not know what the program is doing, or what program location the candidate is being requested for.}
  \label{fig:nil-node}
\end{figure}

...
Before we proceed further, it would be useful to define who we expect to be able to use our web interface. Technical/CS background, able to look at graphs and understand nodes/vertices. Not verification experts.

...
Ad: better placement, esp. for larger graphs
Dis: Lack of reproducibility
Wrong decision
A challenge of force directed layout - the spatial relationship of the original nodes change when you delete one other node (local modification -> global re-layout). That may make it hard for users to understand node correspondence between steps.
